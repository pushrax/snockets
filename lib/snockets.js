...
(function() {
  ...
  module.exports = Snockets = (function() {
    ...
    Snockets.prototype.getConcatenation = function(filePath, flags, callback) {
      var compile, concatenationChanged,
        _this = this;
      if (typeof flags === 'function') {
        callback = flags;
        flags = {};
      ...
      compile = function() {
        var chain, concatenation, e, link, result, _i, _len, _ref, _ref1, _ref2;
        try {
          if ((_ref = _this.concatCache[filePath]) != null ? _ref.data : void 0) {
            ...
            for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
              ...
              concatenation += _this.cache[link].js.toString('utf8') + "\n";
            }
      ...
      return this.updateDirectives(filePath, flags, function(err, graphChanged) {
        ...
        this.depCacheValid = true;
        return compile();
      });
    };

    Snockets.prototype.invalidateDepCache = function() {
      this.depGraph.map = {};
      return this.depCacheValid = false;
    };
    ...
    Snockets.prototype.updateDirectives = function() {
      ...
      if (this.depCacheValid) {
        if (this.depGraph.map[filePath]) {
          return callback();
        }
      }
      depList = [];
    ...
    Snockets.prototype.compileFile = function(filePath) {
      ...
      if ((ext = path.extname(filePath)) === '.js') {
        ...
        if (!this.cache[filePath].valid) {
          console.log(filePath, 'cache miss');
          ...
          this.cache[filePath].valid = true;
        } else {
